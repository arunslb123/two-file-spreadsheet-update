...
function formatDate(oldFormat,duration){
 ...
 var formattedDate1 = new Date(oldFormat);
  if(duration<1){
    formattedDate1.setMinutes(duration*10);
  }else{
...
//  }
   return (formattedDate1.getFullYear()+','+formattedDate1.getMonth()+','+formattedDate1.getDate()+','+formattedDate1.getHours()+','+formattedDate1.getMinutes()+','+formattedDate1.getSeconds());
}
